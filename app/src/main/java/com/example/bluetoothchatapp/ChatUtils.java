...
public class ChatUtils {
 ...
 //Initializing and instance of BluetoothServerSocket by calling the listenUsingRfcommWithServiceRecord() method
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            try {
                socket = serverSocket.accept();//Listening for connection requests by calling accept()
            } catch (IOException e) {
            ...
            if (socket != null) {
                switch (state) {
                    ...
                    case STATE_CONNECTED:
                        try {
                            socket.close();//Release server socket by calling close()
                        } catch (IOException e) {
...
// Create an instance of BluetoothSocket by calling createRfcommSocketToServiceRecord(UUID) () on BluetoothDevice object
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            try {
                socket.connect();//Initializing the connection by calling connect()
            } catch (IOException e) {
